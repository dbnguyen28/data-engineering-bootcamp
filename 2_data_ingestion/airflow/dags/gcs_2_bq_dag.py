...
path_to_local_home = os.environ.get("AIRFLOW_HOME", "/opt/airrflow/")
...
with DAG(
    ...
    catchup=False,
    max_active_runs=1,
    tags=['3_datawarehouse'],
) as dag:

    for taxi_type, ds_col in TAXI_TYPES.items():
        print(f'{INPUT_PART}/{taxi_type}_*')
...
gcs_2_gcs_task >> gcs_2_bq_ext >> bq_ext_2_part
